...
short_description = "HMM model to determine Lo or Ld domains from coarse grained or atomistic MD simulations.".strip().split("\n")[0]
...
setup(
    ...
    install_requires=[
        "mdanalysis>=2.0.0", "hmmlearn", "memsurfer", "pytest"
    ],
